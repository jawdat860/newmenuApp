  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full h-40 flex-[40%] p-[5px]"
      >
        <div
          style={{
        ...
        <div className="flex justify-between">
          ...
          {quantity === 0 ? (
            <button
              ...
              className="bg-[#eee] p-[13px] rounded-tl-[20px] rounded-br-[20px]"
              onClick={ButtonCard}
            >
            ...
            <div
              ...
              className="relative flex items-center rounded-tl-[20px] rounded-br-[20px] max-w-[130px] bg-[#eee] flex-[20%] justify-between px-[8px] aling-center"
            >
              <button
                type="button"
