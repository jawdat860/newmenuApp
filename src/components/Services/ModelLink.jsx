...
const ModelLink = ({ services, activeCategory, activeSubcategory }) => {
  ...
  return (
    <Modal
      ...
      dismissible={true}
      trigger={
        <button className="mx-[6px] px-4 py-2 text-sm font-medium bg-[#ffc001] text-white rounded-full transition-all duration-300 active:bg-primary active:opacity-50 focus:outline-none">
          <FiAlignJustify />
        </button>
      }
